...
namespace Data.Migrations
{
    ...
    [Migration("20241115211421_addGuidPK")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlumnoAusencia", b =>
                {
                    b.Property<Guid>("AusenciasId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("HijosConAusenciaId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AulaNota", b =>
                {
                    b.Property<Guid>("AulasDestinadasId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("NotasParaAulaId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Entities.Evento", b =>
                {
                    ...
                    b.Property<Guid>("AulaDestinadaId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Entities.HistorialAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Entities.LoginAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("FechaYHoraLogin")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("FechaYHoraLogout")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("UsuarioLogueadoId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("UsuarioLogueadoId");
            ...
            modelBuilder.Entity("NotaPersona", b =>
                {
                    b.Property<Guid>("DestinatariosId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("NotasRecibidasId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NotaPersona1", b =>
                {
                    b.Property<Guid>("LeidaPorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("NotasLeidasId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NotaPersona2", b =>
                {
                    b.Property<Guid>("FirmadaPorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("NotasFirmadasId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Model.Entities.Evento", b =>
                {
                    b.HasOne("Model.Entities.Aula", "AulaDestinada")
                        .WithMany("Eventos")
                        .HasForeignKey("AulaDestinadaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Model.Entities.Persona", "Creador")
                        .WithMany()
                        .HasForeignKey("CreadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AulaDestinada");
            ...
            modelBuilder.Entity("Model.Entities.LoginAudit", b =>
                {
                    b.HasOne("Model.Entities.Usuario", "UsuarioLogueado")
                        .WithMany()
                        .HasForeignKey("UsuarioLogueadoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UsuarioLogueado");
                });
