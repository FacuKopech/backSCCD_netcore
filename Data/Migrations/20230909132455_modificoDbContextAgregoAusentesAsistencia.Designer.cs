...
namespace Data.Migrations
{
    ...
    [Migration("20230909132455_modificoDbContextAgregoAusentesAsistencia")]
    partial class modificoDbContextAgregoAusentesAsistencia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlumnoAsistenciaAusentes", b =>
                {
                    b.Property<int>("AsistenciasId")
                        .HasColumnType("int");

                    b.Property<int>("AusentesId")
                        .HasColumnType("int");

                    b.HasKey("AsistenciasId", "AusentesId");

                    b.HasIndex("AusentesId");

                    b.ToTable("AlumnoAsistenciaAusentes");
                });

            modelBuilder.Entity("AlumnoAsistenciaPresentes", b =>
                {
                    b.Property<int>("AsistenciasId")
                        .HasColumnType("int");

                    b.Property<int>("PresentesId")
                        .HasColumnType("int");

                    b.HasKey("AsistenciasId", "PresentesId");

                    b.HasIndex("PresentesId");

                    b.ToTable("AlumnoAsistenciaPresentes");
                });
            ...
            modelBuilder.Entity("AlumnoAsistenciaAusentes", b =>
                {
                    b.HasOne("Model.Entities.Asistencia", null)
                        .WithMany()
                        .HasForeignKey("AsistenciasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Model.Entities.Alumno", null)
                        .WithMany()
                        .HasForeignKey("AusentesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
